      ...
      <body className='bg-white'>
        ...
        {children}
         ...
         <div>
             ...
             <p className="text-sm text-gray-400  leading-8 sm:w-3/4">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptatibus, reprehenderit accusamus ipsa tempore debitis magnam, deleniti vel commodi quisquam quia aliquam aut incidunt natus, architecto harum eaq</p>
         ...
         <div>
              ...
              <p className="text-sm text-gray-400  leading-8">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptatibus, reprehenderit accusamus ipsa tempore debitis magnam, deleniti vel commodi quisquam quia aliquam aut incidunt natus, architecto harum eaq</p>
              <form action="" className="mt-8 flex flex-col gap-5">
                ...
                <div className='flex flex-col gap-5 sm:flex-row'>
                 ...
                 <button className="bg-amber-400 text-white p-3 text-sm font-bold " type="submit">Send</button>

              </form>
         </div>
      </section>

      <section className="w-full px-12 sm:px-16 py-6 bg-gray-700 sm:flex gap-8 border-t border-b lg:px-24">
          <div className="sm:w-1/2">
             <h4 className="text-amber-400 font-semibold text-xl">Subscribe To Our News Letter</h4>
             <p className="text-sm mt-4 text-gray-400  leading-8">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptatibus, reprehenderit accusamus ipsa tempore debitis magnam.</p>
          </div>
          <form className="mt-4 flex flex-col sm:flex-row h-max relative sm:w-1/2 sm:top-11">
              <input className="p-3 text-sm focus:outline-0 text-gray-600 sm:w-full" placeholder="Email"  type="email"/>
