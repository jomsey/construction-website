...
export default function NavLink({ path, children }) {
    ...
    const siteNavLinkClasses = `${pathName.startsWith(path) ? 'text-green-500' : 'text-gray-300 md:text-gray-700'} font-semibold hover:text-green-500 transition-colors ease-in duration-300`
    return (
        <li >
