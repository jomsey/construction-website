   ...
   return (
      <footer className='bg-gray-700 p-12 lg:px-24 pb-0 '>
         <section className='sm:grid grid-cols-5 gap-5'>
            ...
            <div>
               <h6 className='font-bold text-sm mt-4 text-green-500'>Site Links</h6>
            ...
            <div>
               <h6 className='font-bold text-sm mt-4 text-green-500'>More Info</h6>
               <nav className='flex flex-col w-full'>
                  <ul className='flex flex-col gap-2  mt-4'>
            ...
            <div>
               <h6 className='font-bold text-sm mt-4 text-green-500'>Social Media</h6>
